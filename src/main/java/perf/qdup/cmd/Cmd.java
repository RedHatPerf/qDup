...
public abstract class Cmd {
    ...
    public static boolean isSingleStateReference(String input){
        return input.startsWith(STATE_PREFIX) && input.endsWith(STATE_SUFFIX) && input.indexOf(STATE_PREFIX,1) == -1;
    }
